...
def main():
    ...
    # Build CA certificate with all required key usages
    cert = (
        ...
        .add_extension(
            x509.KeyUsage(
                ...
                key_agreement=False,
                key_cert_sign=True,  # ✅ allow signing other certs
                crl_sign=True,       # ✅ allow signing CRLs
                encipher_only=False,
                decipher_only=False,
            ),
            critical=True,
    ...
    print("✅ Generated CA key and certificate at:", OUT_DIR)
